...
if (assetFiles.length !== 15) failures.push(`expected 15 BodyParts3D GLBs, received ${assetFiles.length}`);
if (assetBytes > 20_000_000) failures.push(`BodyParts3D runtime assets exceed 20 MB: ${assetBytes}`);
if (failures.length) throw new Error(failures.join("\n"));
